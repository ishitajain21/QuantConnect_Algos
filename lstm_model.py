'''
Credit to https://github.com/ksjagtap/QuantConnect-Trading-Strategies/blob/master/AUDUSD_LSTM_model.py. 
Algorithm uses LSTMs to predict the price of currency. If it predicts that the value will increase, we should buy. 
Stats(2023-2024): 
$96,178.40
Equity
-$0.00
...
The stats show that this signal is overtraded and not a valuable method of generating alpha.  
'''
...
class ForexTrade(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        self.Debug(self.labels)
        self.Debug(ytd_close)
